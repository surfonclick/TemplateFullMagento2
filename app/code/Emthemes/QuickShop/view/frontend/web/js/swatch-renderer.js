...
define([
    ...
    $.widget('mage.SwatchRenderer', {
        options: {
            ...
            selectorProduct: '.product-cart-right',
        ...
        _RenderControls: function () {
            ...
            $.each(this.options.jsonConfig.attributes, function () {
				...
				console.log($widget.productForm);
                if ($widget.productForm) {
					console.log(input);
                    $(".product-options-bottom").append(input);
                    input = '';
                }
        ...
        _OnClick: function ($this, $widget) {
			...
			var element_input=$input.selector.replace("form:first ","");
            jQuery(element_input).attr("value",$this.attr('option-id'));
        },
        ...
        _LoadProductMedia: function () {
			...
			if(typeof productId === 'undefined'){
				productId =jQuery("#quickshop .price-final_price").attr('data-product-id');
			}
            mediaCallData = {
        ...
        _EnableProductMediaLoader: function ($this) {
            ...
            } else if($('#quickshop .quickshop-media').size() > 0) {
				$('#quickshop .quickshop-media').find(".fotorama__img").addClass($widget.options.classes.loader);
			}
			else{
                //Category View
        ...
        _DisableProductMediaLoader: function ($this) {
            ...
            if ($('body.catalog-product-view').size() > 0) {
				...
				$('#quickshop .quickshop-media').find(".fotorama__img").removeClass($widget.options.classes.loader);
			}
			else {
                //Category View
                $this.parents('.product-item-info').find('.product-image-photo')
        ...
        updateBaseImage: function (images, context, isProductViewExist) {
			...
			if($('#quickshop .quickshop-media')){
				$('#quickshop .quickshop-media .fotorama__img').attr('src', justAnImage.img);
			}
        },
